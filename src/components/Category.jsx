      ...
      >
        ...
        <Modal.Body>
          <div className='border border-secondary p-3 rounded'>
            <input className='form-control' value={categoryName} onChange={(e) => setcategoryName(e.target.value)} placeholder='Category' type="text" name="" id="" />
          </div>
        </Modal.Body>
        <Modal.Footer>
          ...
          <div className='border border-secondary p-3 rounded mb-3' droppable onDragOver={(e) => ondrag(e)} onDrop={(e) => VideoDrop(e, item)}>
            ...
            </div>
            {
              item?.allvideos?.length > 0 && item?.allvideos?.map((video) => (
                <div className='mb-3' draggable onDragStart={(e) => videoDrag(e,video,item)}>
